...
std::vector<cv::Point2f> estimateTranRotVvel(std::vector<cv::Point2f> vectors, double a, double fx, double fy,
                                             double range, double allsac_radiusSQ, double duration,
                                             double max_vert_speed, double max_yaw_speed){
