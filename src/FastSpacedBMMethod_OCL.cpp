...
FastSpacedBMMethod::FastSpacedBMMethod(int i_samplePointSize,
                                     ...
                                     bool i_storeVideo, std::string *videoPath)
    {
    initialized = false;
...
std::vector<cv::Point2f> FastSpacedBMMethod::processImage(cv::Mat imCurr_t, bool gui, bool debug, cv::Point midPoint_t, double yaw_angle, cv::Point2d tiltCorr)
{
